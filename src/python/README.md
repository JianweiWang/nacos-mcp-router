...
#### Usage
The usage of proxy mode is similar to that of router mode, with slightly different parameters，add environment variables: `MODE=proxy,PROXIED_MCP_NAME=$PROXIED_MCP_NAME`. Docker deployment is recommended.
```
